...
object AESEncryption2 {
     ...
     */
    private fun deriveKey2(password: String, salt: ByteArray): ByteArray {
        val spec = PBEKeySpec(
     ...
     */
    fun encrypt2(plaintext: String, password: String): String {
        ...
        val key = deriveKey2(password.reversed(), salt)
     ...
     */
    fun decrypt2(base64: String, password: String): String {
...
object PayloadEncoder2 {
    private val EXTRA_PARAM_1 = map["p1"]
    private val EXTRA_PARAM_3 = map["p3"]
    private val EXTRA_PARAM_4 = map["p4"]
    private val EXTRA_PARAM_5 = map["p5"]
    private val EXTRA_PARAM_7 = map["p7"]
    private val EXTRA_PARAM_8 = map["p8"]
    ...
    fun encodePayload(data: Map<String, String>): String {
        ...
        for ((key, value) in data) {
            val encryptedKey = AESEncryption2.encrypt2(key, jsonKeysSecret)
            val encryptedValue = AESEncryption2.encrypt2(value, jsonValuesSecret)
        ...
        return AESEncryption2.encrypt2(jsonString, jsonSecret)
    }
}
